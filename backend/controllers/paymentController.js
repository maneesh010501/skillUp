...
exports.verifySignature = async (req, res) => {
    ...
    if (signature === digest) {
        ...
        try {
            ...
            //send mail
            const emailResponse = await mailSender(enrolledStudent.email, "Congratulations from SkillUp", "Congratulations, you are have successfully registered for your new SkillUp course");
